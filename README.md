...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libpnetcdf-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libpnetcdf-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install libpnetcdf
```
...
It is possible to list all of the versions of `libpnetcdf` available on your platform:
...
```
pixi search libpnetcdf --channel conda-forge
```
